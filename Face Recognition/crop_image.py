...
cv2.imwrite("cropped_folder/sapid.jpg", sapId)
cv2.imwrite("cropped_folder/courseName.jpg", courseName)
cv2.imwrite("cropped_folder/program.jpg", program)
cv2.imwrite("cropped_folder/marks.jpg", marks)
